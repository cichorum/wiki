...
- Is it acceptable for AI systems to influence government decisions at a potentially life-altering scale?
- Is technology truly “neutral?”

**What the issue calls for:** 
- Stronger ethical frameworks surrounding software engineering, especially in corporate contexts.
- More concrete policies and standards surrounding the usage of AI models in government products.
...
- Where is the boundary between fair use and exploitation in machine learning training practices?

**What the issue calls for:**
- Clear legal standards defining whether training AI models on copyrighted material qualifies as fair use.
- Transparent disclosure of training datasets and data sourcing practices.
- Ethical guidelines for generative AI companies regarding attribution, style replication, and derivative works.
...
- Does designing software that targets specific user groups (like government officials) violate principles of fairness and integrity?


**What the issue calls for:**
- Stronger internal ethical review processes for high-risk product decisions.
- Reinforcement of professional engineering ethics standards.
- Clear corporate policies regarding software designed to obstruct lawful oversight.
...
[Requirements Page](https://www.cs.unc.edu/~stotts/COMP523-s25/ethicsAssn.html)